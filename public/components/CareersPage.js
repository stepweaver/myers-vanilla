    ...
    <div class="careers-page">
      ...
      <section class="careers-hero">
        <div class="careers-hero-container">
          ...
          <p class="careers-hero-subtitle">
            Be part of a dynamic team that's passionate about creating beautiful smiles and providing exceptional patient care. Discover your next career opportunity with Lambda Orthodontics.
          </p>
        </div>
      </section>
      ...
      <section class="careers-benefits-section">
        <div class="careers-benefits-container">
          <h2 class="careers-section-title text-center">Why Work at Lambda Orthodontics?</h2>
